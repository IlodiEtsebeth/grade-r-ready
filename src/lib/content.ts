...
export const CATEGORIES: ChecklistCategory[] = [
  {
    ...
    items: [
      {
        id: "social-1",
        label: "Separates from parent with confidence",
        hint: "Drop-off at school",
      },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "lang-5", label: "Knows some letter sounds", hint: "Starts with 's'" },
  ...
  },
  {
    ...
    items: [
      {
        id: "ind-1",
        label: "Washes hands and uses the toilet on their own",
        hint: "Daily routine",
      },
...
export const WEEKS: ActivityWeek[] = [
    ...
    activities: [
      {
        ...
        detail: "Read a picture book, then ask who, what and where questions.",
        minutes: 15,
        skill: "Language",
      },
      {
        ...
        detail: "Count out 10 snacks or blocks together, then take some away and count again.",
        minutes: 10,
        skill: "Numeracy",
      },
      {
        id: "w1-a3",
        title: "Two-step instruction game",
        detail: "Give playful two-step instructions like 'hop twice and touch your nose'.",
        minutes: 10,
        skill: "Listening",
      },
    ],
    ...
    activities: [
      {
        ...
        detail: "Write your child's name in dots and let them trace over it three times.",
        minutes: 10,
        skill: "Writing",
      },
      {
        id: "w2-a2",
        title: "Name hunt",
        detail: "Look for the first letter of their name on packets, signs and books.",
        minutes: 10,
        skill: "Literacy",
      },
      {
        id: "w2-a3",
        title: "Rhyme time",
        detail: "Say a word and take turns finding words that rhyme with it.",
        minutes: 10,
        skill: "Language",
      },
    ],
    ...
    activities: [
      {
        ...
        detail: "Draw straight and wavy lines on paper for your child to cut along.",
        minutes: 15,
        skill: "Motor",
      },
      {
        id: "w3-a2",
        title: "Colour inside the shape",
        detail: "Draw big shapes and colour them in without going over the lines.",
        minutes: 10,
        skill: "Motor",
      },
      {
        id: "w3-a3",
        title: "Shape hunt at home",
        detail: "Find circles, squares and triangles around the house.",
        minutes: 10,
        skill: "Numeracy",
      },
    ],
  },
  {
    ...
    activities: [
      {
        id: "w4-a1",
        title: "Sort the washing",
        detail: "Sort socks or blocks by colour, then by size.",
        minutes: 10,
        skill: "Numeracy",
      },
      {
        ...
        detail: "Make a bead or block pattern and ask your child to copy it.",
        minutes: 10,
        skill: "Numeracy",
      },
      {
        ...
        detail: "Ask your child to tell you three things that happened, in order.",
        minutes: 10,
        skill: "Language",
      },
    ],
    ...
    activities: [
      {
        id: "w5-a1",
        title: "Play school",
        detail: "Role-play the school day: bell, sitting on the mat, packing away.",
        minutes: 15,
        skill: "Social",
      },
      {
        id: "w5-a2",
        title: "Pack my own bag",
        detail: "Let your child pack and carry their bag on their own.",
        minutes: 10,
        skill: "Independence",
      },
      {
        id: "w5-a3",
        title: "Lunchbox practice",
        detail: "Practise opening the lunchbox and bottle without help.",
        minutes: 10,
        skill: "Independence",
      },
    ],
  },
  {
    ...
    activities: [
      {
        id: "w6-a1",
        title: "Number spotting",
        detail: "Look for numbers 1 to 10 on doors, cars and packets.",
        minutes: 10,
        skill: "Numeracy",
      },
      {
        id: "w6-a2",
        title: "More, less or same",
        detail: "Share snacks into two piles and ask which has more.",
        minutes: 10,
        skill: "Numeracy",
      },
      {
        id: "w6-a3",
        title: "Count and jump",
        detail: "Count out loud while jumping, clapping or stamping.",
        minutes: 10,
        skill: "Motor",
      },
    ],
    ...
    activities: [
      {
        ...
        detail: "Draw happy, sad and cross faces and talk about when we feel them.",
        minutes: 10,
        skill: "Social",
      },
      {
        id: "w7-a2",
        title: "Take turns game",
        detail: "Play a simple board or card game and practise waiting for a turn.",
        minutes: 15,
        skill: "Social",
      },
      {
        ...
        detail: "Read a story and ask what your child thinks happens next.",
        minutes: 10,
        skill: "Language",
      },
    ],
    ...
    activities: [
      {
        ...
        detail: "Thread beads, pasta or buttons onto string.",
        minutes: 10,
        skill: "Motor",
      },
      {
        ...
        detail: "Draw a family picture, checking the pencil grip stays comfortable.",
        minutes: 10,
        skill: "Motor",
      },
      {
        id: "w8-a3",
        title: "Tear and paste",
        detail: "Tear paper into small pieces and paste them into a picture.",
        minutes: 15,
        skill: "Motor",
      },
    ],
    ...
    activities: [
      {
        ...
        detail:
          "This week's sounds are s, a, t, i, p, n \u2014 the first sounds taught in Grade R. Pick one each day and find three things that start with it.",
        minutes: 10,
        skill: "Literacy",
      },
      {
        ...
        detail: "Clap out the parts of family names and food words.",
        minutes: 10,
        skill: "Literacy",
      },
      {
        id: "w9-a3",
        title: "Write it in sand",
        detail: "Write the letters s, a, t, i, p, n in sand, flour or on a steamy window.",
        minutes: 10,
        skill: "Writing",
      },
      {
        ...
        title: "Build a word",
        detail:
          "Using only s, a, t, i, p, n, say a simple word out loud \u2014 like sat, tap, pin or nap \u2014 and help your child sound it out and find the matching letters.",
        minutes: 10,
        skill: "Literacy",
      },
    ],
  },
  {
    ...
    activities: [
      {
        id: "w10-a1",
        title: "Dress myself race",
        detail: "Time your child getting dressed and putting on shoes.",
        minutes: 10,
        skill: "Independence",
      },
      {
        id: "w10-a2",
        title: "Bathroom on my own",
        detail: "Practise the full routine: toilet, flush, wash and dry hands.",
        minutes: 10,
        skill: "Independence",
      },
      {
        id: "w10-a3",
        title: "Pack away timer",
        detail: "Set a 5 minute timer and pack away all toys together.",
        minutes: 10,
        skill: "Independence",
      },
    ],
  },
  {
    ...
    activities: [
      {
        id: "w11-a1",
        title: "Write my whole name",
        detail: "Write the full name without tracing, then celebrate the attempt.",
        minutes: 10,
        skill: "Writing",
      },
      {
        id: "w11-a2",
        title: "Count to 20",
        detail: "Count objects past 10 and see how far your child can go.",
        minutes: 10,
        skill: "Numeracy",
      },
      {
        ...
        detail: "Read a story, then let your child retell it in their own words.",
        minutes: 15,
        skill: "Language",
      },
    ],
  },
  {
    ...
    activities: [
      {
        id: "w12-a1",
        title: "Big school talk",
        detail: "Talk about what Grade 1 will be like and answer any worries.",
        minutes: 10,
        skill: "Social",
      },
      {
        id: "w12-a2",
        title: "Full morning practice",
        detail: "Do a full morning routine on their own: dress, eat, pack, go.",
        minutes: 15,
        skill: "Independence",
      },
      {
        id: "w12-a3",
        title: "Show what I can do",
        detail: "Let your child show off name writing, counting and cutting.",
        minutes: 15,
        skill: "Review",
      },
    ],
